    ...
    <section className="relative overflow-hidden" style={{ minHeight: "100vh", background: "#A8CCE0" }}>
      ...
      <div className="absolute inset-0 block md:hidden" style={{ zIndex: 0 }}>
        ...
        <div 
          ...
          style={{ 
            background: "linear-gradient(to top, rgba(26,77,46,0.6) 0%, rgba(26,77,46,0.3) 30%, transparent 60%)",
            zIndex: 1 
          }} 
        />
      </div>
      ...
      {/* ── Content ── */}
      <div className="relative flex flex-col min-h-[100dvh]" style={{ zIndex: 2 }}>

        {/* Main area: text left + floating cards right */}
        <div className="flex-1 flex flex-col relative pt-20 md:pt-40 pb-24 min-h-[100dvh]">
          ...
          >
            <div className="flex flex-col items-start">
              ...
              >
                ...
                <span className="text-brand-gold">YOUR</span>
            ...
            {/* Bottom Group — CTAs and Stats — Hard-pinned to bottom on mobile */}
            <div className="md:mt-auto pb-10 md:pb-0 absolute bottom-8 left-6 right-6 md:static flex flex-col gap-6 items-start">
              <motion.div
                initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}

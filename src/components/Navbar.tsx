...
function NavCTA({ mobile, onClick }: { mobile?: boolean; onClick?: () => void }) {
  ...
  const href  = isMentor ? "/mentorship#mentors"     : "/mentorship?type=mentor#apply";
...
const navLinks = [
  { href: "/mentorship",          label: "Home" },
  { href: "/mentorship#mentors",  label: "Mentors" },
  { href: "/mentorship#about",    label: "About" },
  { href: "/mentorship#contact",  label: "Contact" },
];

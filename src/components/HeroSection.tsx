      ...
      <div className="relative flex flex-col md:min-h-[100dvh]" style={{ zIndex: 2 }}>
        ...
        <div className="flex-1 flex flex-col relative pt-24 md:pt-40 pb-20 md:min-h-[100dvh]">
          ...
          >
            ...
            {/* Mobile-only Image Block — positioned here to clear the face and start after top text */}
            <motion.div 
              initial={{ opacity: 0, scale: 1.05 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="w-[calc(100%+3rem)] -ml-6 relative md:hidden mb-10 overflow-hidden"
            ...
            >
              ...
              <div 
                ...
                style={{ 
                  background: "linear-gradient(to top, #A8CCE0 0%, transparent 20%, transparent 80%, #A8CCE0 100%)",
                }} 
              />
            </motion.div>

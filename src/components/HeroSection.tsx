  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: "100vh", background: "#A8CCE0" }}>
      ...
      <div className="relative flex flex-col" style={{ minHeight: "100vh", zIndex: 2 }}>
        ...
        <div className="flex-1 relative" style={{ paddingTop: "clamp(60px, 10vh, 80px)", mdPaddingTop: "96px", paddingBottom: "24px" } as any}>

          {/* Left text column */}
          <div
            className="flex-1 flex flex-col justify-between px-6 md:px-14 w-full md:max-w-[42vw] lg:max-w-[500px] items-start relative"
          ...
          >
            ...
            <motion.span
              ...
              style={{
                ...
                border: "1px solid rgba(26,77,46,0.30)", borderRadius: "50px",
                padding: "4px 12px",
            ...
            {/* Bottom Group — CTAs and Stats — Pinned to bottom on mobile */}
            <div className="pb-10 md:pb-0 md:relative absolute bottom-4 left-6 right-6 md:bottom-auto md:left-auto md:right-auto flex flex-col gap-6 items-start">
              <motion.div
                initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}

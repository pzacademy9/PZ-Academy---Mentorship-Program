...
export default function HeroSection() {
  ...
  // Desktop: fade at 0.5, Mobile: fade at 0.4
  const isMobile = typeof window !== 'undefined' && window.innerWidth < 768;
  const fadeThreshold = isMobile ? 0.4 : 0.5;
  const fadeOut  = useTransform(scrollYProgress, [0, fadeThreshold], [1, 0]);
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* CTAs - hidden on mobile, shown below */}
            <div className="hidden sm:block">
              <Suspense fallback={<div style={{ height: 88 }} />}>
                <HeroCTAs mobile={false} />
              </Suspense>
            </div>
            ...
            <div style={{ display: "none", gap: 6, flexWrap: "wrap" }} className="hidden sm:flex">
        ...
        {/* ══════════════════════════════════════════════
            MOBILE CTAs — after hero background
        ══════════════════════════════════════════════ */}
        <div
            ...
            <div style={{ paddingLeft: "clamp(40px,6vw,80px)", paddingRight: 40, paddingBottom: 40, paddingTop: 40 }}>
              <div style={{ maxWidth: "clamp(380px,44vw,500px)" }}>
                ...
                <motion.div
                  ...
                  style={{
                    display: "inline-flex", alignItems: "center", gap: "clamp(3px,1vw,6px)", marginBottom: "clamp(12px,3vw,20px)",
                    fontSize: "clamp(6.5px,1.1vw,8px)", fontWeight: 700, letterSpacing: "0.18em",
                    textTransform: "uppercase", color: "#1A4D2E",
                    border: "1px solid rgba(26,77,46,0.22)", borderRadius: "50px",
                  ...
                  className="sm:hidden"
                >
                  <Sparkles size="clamp(6px,1vw,8px)" style={{ color: "#C9A84C", flexShrink: 0 }} />
                  Premier Mentorship
                </motion.div>

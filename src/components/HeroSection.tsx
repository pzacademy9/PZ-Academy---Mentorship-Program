      ...
      >
        ...
        >
          ...
          <img
            ...
            style={{
              /*
               * Image is 1080×2400 portrait — taller than any phone screen.
               * We want the FULL WIDTH visible (no horizontal crop) and
               * the image anchored to the bottom so the girl's full body shows.
               *
               * width:100% + height:auto = natural proportions, no crop at all.
               * The image will be taller than the viewport — that's fine because
               * the section clips it with overflow:hidden.
               * position:absolute + bottom:0 anchors her feet to the bottom.
               */
              position: "absolute",
              bottom: 0,
              left: 0,

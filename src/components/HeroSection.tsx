        ...
        <div className="flex-1 flex flex-col relative pt-24 md:pt-40 pb-20 md:min-h-[100dvh]">
          ...
          >
            ...
            <motion.div 
              ...
              className="w-[calc(100%+3rem)] -ml-6 relative md:hidden mb-20 overflow-hidden"
            ...
            >
              ...
              />
              {/* Ultra-smooth professional multi-stop fade */}
              <div 
                className="absolute inset-0 pointer-events-none" 
                style={{ 
                  background: "linear-gradient(to bottom, #A8CCE0 0%, rgba(168, 204, 224, 0.9) 3%, rgba(168, 204, 224, 0.4) 7%, transparent 12%, transparent 88%, rgba(168, 204, 224, 0.4) 93%, rgba(168, 204, 224, 0.9) 97%, #A8CCE0 100%)",
                }} 
              />
            </motion.div>

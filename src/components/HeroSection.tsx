...
export default function HeroSection() {
  ...
  // Parallax for BG images
  const bgY = useTransform(scrollYProgress, [0, 1], ["0%", "18%"]);

  // Fade: stays fully visible until 50% scroll, then fades out by 90%
  // Applied to BOTH mobile and desktop content
  ...
  return (
    <>
      ...
      >
        ...
        {/* ══════════════════════
            MOBILE BACKGROUND
            Full 100dvh cover, girl right
        ══════════════════════ */}
        <div className="absolute inset-0 md:hidden" style={{ zIndex: 0 }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/hero-banner-mobile.png" alt="" aria-hidden
            style={{
              width: "100%", height: "100%",
              objectFit: "cover",
              objectPosition: "72% center",   /* girl anchored right half */
            }}
          />
          {/* Left text-zone fade — stops at ~55% width so girl is untouched */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to right, rgba(168,204,224,0.90) 0%, rgba(168,204,224,0.65) 28%, rgba(168,204,224,0.18) 52%, transparent 64%)",
          }} />
          {/* Top — behind nav area */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to bottom, rgba(168,204,224,0.65) 0%, transparent 20%)",
          }} />
          {/* Bottom — behind CTAs */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to top, rgba(168,204,224,0.85) 0%, rgba(168,204,224,0.35) 20%, transparent 36%)",
          }} />
        </div>
        ...
        {/* ══════════════════════════════════════════════════════
            MOBILE UI — scroll-fade wrapper around BOTH blocks
        ══════════════════════════════════════════════════════ */}
        <motion.div
          className="md:hidden"
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              top: NAV_HEIGHT + 16,
              left: 20,
              /* Hard right wall so text never overlaps girl */
              right: "46%",
            }}
          >
            {/* Badge pill — full text, auto-wrap to 2 lines if needed */}
            <motion.div
              ...
              style={{
                ...
                /* Allow full text — wraps gracefully if narrow */
                whiteSpace: "normal",
                lineHeight: 1.4,
                maxWidth: "100%",
              }}
            ...
            <h1
              ...
              style={{
                fontSize: "clamp(34px,10.5vw,48px)",
          ...
          {/* BOTTOM-LEFT: CTAs + star trust line only (no stat pills) */}
          <div
            style={{
              position: "absolute",
              bottom: 28,
          ...
          >
            ...
            >
              ...
              {/* Stars trust line — no stat pills */}
        ...
        {/* ══════════════════════════════════════════════════════
            DESKTOP LAYOUT — scroll fade starts at 50%
        ══════════════════════════════════════════════════════ */}
        <motion.div

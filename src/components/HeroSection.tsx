    ...
    <section className="relative overflow-hidden" style={{ minHeight: "100vh", background: "#A8CCE0" }}>
      ...
      <div className="relative flex flex-col" style={{ minHeight: "100vh", zIndex: 2 }}>
        ...
        <div className="flex-1 relative" style={{ paddingTop: "96px", paddingBottom: "24px" }}>
          ...
          {/* Left text column */}
          <div
            className="flex flex-col md:justify-center justify-start h-full px-8 md:px-14 w-full md:max-w-[42vw] lg:max-w-[500px]"
          ...
          >
            ...
            {/* Mobile stat pills — shown only on mobile at the bottom */}
            <div className="mt-auto pb-10 flex flex-wrap gap-2 md:hidden">
              {FLOAT_STATS.map((s) => (
                <div
                  key={s.label}

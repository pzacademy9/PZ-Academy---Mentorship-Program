...
export default function HeroSection() {
  ...
  // PC content fade — only starts at 50% scroll, fully gone at 90%
  // FIX: was [0, 0.55] → now [0.5, 0.9] so half the section is scrolled before fade begins
  const contentOpacity = useTransform(scrollYProgress, [0, 0.5, 0.9], [1, 1, 0]);
  const contentY       = useTransform(scrollYProgress, [0.5, 0.9], ["0%", "8%"]);
  ...
  return (
    <>
      ...
      >
        ...
        {/* ══════════════════════════
            MOBILE BACKGROUND
            Full 100dvh, girl anchored right
        ══════════════════════════ */}
        <div
        ...
        >
          ...
          <img
            ...
            style={{
              ...
              height: "100%",
              objectFit: "cover",
              /* Push girl to right half — left 45% stays clear for text */
          ...
          {/*
            ...
            Covers roughly left 50% with a strong fade so text is always readable.
            Right 50% = 0 opacity = girl fully visible.
          */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to right, rgba(168,204,224,0.92) 0%, rgba(168,204,224,0.75) 30%, rgba(168,204,224,0.30) 52%, transparent 65%)",
          }} />

          {/* Top edge — keeps area under nav clean */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to bottom, rgba(168,204,224,0.70) 0%, transparent 18%)",
          }} />

          {/* Bottom edge — behind CTA block only */}
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "linear-gradient(to top, rgba(168,204,224,0.82) 0%, rgba(168,204,224,0.40) 18%, transparent 32%)",
          }} />
        </div>
        ...
        <div
          ...
          style={{
            zIndex: 1,
            backgroundImage: "linear-gradient(rgba(26,77,46,0.032) 1px,transparent 1px),linear-gradient(90deg,rgba(26,77,46,0.032) 1px,transparent 1px)",
        ...
        {/* ══════════════════════════
            MOBILE UI — absolute positioned
            Top-left: badge + headline + typewriter
            Bottom-left: CTAs + trust + stats
        ══════════════════════════ */}
        ...
        <div
          ...
          style={{
            top: NAV_HEIGHT + 18,
            left: 20, right: "48%",  /* right boundary = 48% so text never overlaps girl on right */
            zIndex: 4,
          }}
        >
          ...
          >
            <Sparkles size={6} style={{ color: "#C9A84C", flexShrink: 0 }} />
            Pakistan&apos;s Premier
          </motion.div>
          ...
          <motion.p
            ...
            style={{ fontSize: "11px", color: "#1A4D2E", letterSpacing: "-0.01em" }}
          >
            Mentors for <Typewriter />
          </motion.p>
        </div>

        {/* BOTTOM-LEFT CTAs + stats */}
        <div
          className="md:hidden absolute"
          style={{
            bottom: 28,
        ...
        >
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.70 }}
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
              ...
              <span
                ...
                style={{
                  fontSize: "9.5px", color: "rgba(26,77,46,0.80)",
                  fontWeight: 500,
                  textShadow: "0 1px 4px rgba(255,255,255,0.55)",
                }}
              >

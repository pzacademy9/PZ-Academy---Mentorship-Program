  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: "100vh", background: "#A8CCE0" }}>
      ...
      <div className="relative flex flex-col min-h-[100dvh]" style={{ zIndex: 2 }}>
        ...
        <div className="flex-1 flex flex-col relative pt-4 md:pt-40 pb-24 min-h-[100dvh]">
          ...
          >
            ...
            <div className="md:mt-auto pb-10 md:pb-0 absolute bottom-12 left-6 right-6 md:static flex flex-col gap-6 items-start">
              <motion.div
                initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}

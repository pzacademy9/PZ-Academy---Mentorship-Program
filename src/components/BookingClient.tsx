                ...
                <div className="bg-black/25 border border-white/10 hover:border-brand-gold/40 p-4 rounded-xl transition-colors group">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="font-montserrat font-bold text-brand-gold tracking-tight text-sm mt-1">
                        @PharmacozymeOfficial
                      </p>
                      <a 
                        href="https://paypal.me/PharmacozymeOfficial" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="inline-block font-poppins text-[10px] text-brand-gold/80 underline mt-1 hover:text-brand-gold"
                      >
                        paypal.me/PharmacozymeOfficial
                      </a>
                    </div>
                    <CopyButton text="@PharmacozymeOfficial" />
                  </div>
                </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="font-poppins text-xs text-white/40 mt-1">
                        PHARMACOZYME (PRIVATE) LIMITED
                      </p>
                    </div>
                    <CopyButton text="3573499000006913" />
                  </div>
                </div>
